...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<i><b>{file_caption}</b>   \n <b> 🔰 Pᴏᴡᴇʀᴇᴅ Bʏ ➜ @Knmlpro2 \n 🔰  Gʀᴏᴜᴘ ➜ @Knmlpro2_group </b></i>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<i><b>{file_caption}</b>   \n <b> 🔰 Pᴏᴡᴇʀᴇᴅ Bʏ ➜ @Knmlpro2 \n 🔰  Gʀᴏᴜᴘ ➜ @Knmlpro2_group </b></i>")
...
DOWNLOAD_TEXT_URL = "https://t.me/open_link_trick/8"
